            ...
            <Dropdown.Content>
                {feature && (
                    <>
                        ...
                        <Link href={`/feature.destroy/${feature.id}`} method="delete" as="button" className="block px-4 py-2 text-sm text-red-600 hover:bg-red-100 dark:text-red-400 dark:hover:bg-red-700">
                            Delete
                        </Link>
                    </>
                )}
